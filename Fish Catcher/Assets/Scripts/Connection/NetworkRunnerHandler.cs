...
public class NetworkRunnerHandler : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    {
        var clientTask = InitializeNetworkRunnerTask(_currentRunner, GameMode.Host, sessionName, SceneUtility.GetBuildIndexByScenePath($"Scenes/{sceneName}"));
    }

    public void JoinGame(SessionInfo sessionInfo)
    {
        var clientTask = InitializeNetworkRunnerTask(_currentRunner, GameMode.Client, sessionInfo.Name, SceneManager.GetActiveScene().buildIndex);
    }

    async Task InitializeNetworkRunnerTask(NetworkRunner runner, GameMode gameMode, string sessionName, SceneRef scene)
    {
